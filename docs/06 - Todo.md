...
- [ ] Recetter manuellement dans le navigateur : parcourir la réunion de production jusqu'à la nouvelle étape, vérifier l'affichage par machine (désignation, client, article, quantité) en mode ERP réel et en mode démonstration (sans import actif), créer une action depuis un OF et confirmer qu'elle apparaît bien sur la fiche de cet OF puis dans la revue des actions d'une prochaine réunion.
