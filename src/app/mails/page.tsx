    ...
    <AppShell activeSection="mails" headerTitle="Mails">
      <div className="mx-auto max-w-7xl">
        <header>
          ...
          <Link href="/mails/assistant" className="mt-5 inline-flex min-h-11 items-center rounded-xl bg-[#195c45] px-5 text-sm font-semibold text-white">Démarrer ma session mails</Link>
        </header>
        <MailWorkspaceLoader />
      </div>
    </AppShell>
