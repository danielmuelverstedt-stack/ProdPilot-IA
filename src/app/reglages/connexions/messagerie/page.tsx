  ...
  return (
    <AppShell activeSection="settings" headerTitle="Réglages">
      <div className="mx-auto max-w-7xl">
        ...
        <aside className="mt-6 flex flex-col gap-3 rounded-2xl border border-[#d7e4de] bg-[#f7faf8] p-4 text-sm text-[#40554b] sm:flex-row sm:items-center sm:justify-between"><p><strong>Compte actif unique.</strong> Gmail utilise OAuth côté serveur. Un compte de démonstration permet de tester l’interface sans connexion externe.</p><Link href="/mails/diagnostic" className="shrink-0 rounded-xl border border-[#cbd7d1] bg-white px-4 py-2 font-semibold">Ouvrir le diagnostic Mail</Link></aside>
