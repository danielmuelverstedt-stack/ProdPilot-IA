...
export const initialDemoData: DemoData = {
  ...
  actions: [
    { id: "ACT-001", dateEncodage: "2026-07-11", introduitPar: "Daniel Mülverstedt", origine: "QRQC", contextLink: { module: "meeting", id: "MEET-QRQC-12", label: "MEET-QRQC-12", href: "/reunions/qrqc" }, description: "Confirmer la fenêtre de maintenance FRA-10 — Valider avec la maintenance que l’OF-240184 peut démarrer mardi.", responsable: "Marc Lambert", echeance: "2026-07-13", statut: "À faire", dateCloture: null, remarque: "Créneau proposé à 05 h 00." },
    { id: "ACT-002", dateEncodage: "2026-07-10", introduitPar: "Daniel Mülverstedt", origine: "Planning", contextLink: { module: "workOrder", id: "OF-240191", label: "OF-240191", href: "/of/OF-240191" }, description: "Relancer le fournisseur matière — Obtenir une date ferme pour le complément 316L.", responsable: "Sophie Martin", echeance: "2026-07-14", statut: "À faire", dateCloture: null, remarque: null },
    { id: "ACT-003", dateEncodage: "2026-07-13", introduitPar: "Daniel Mülverstedt", origine: "Parc machines", contextLink: { module: "machine", id: "FIL-01", label: "FIL-01", href: "/machines/FIL-01" }, description: "Replanifier la découpe fil — Identifier une alternative compatible pendant la panne FIL-01.", responsable: "Sophie Planification", echeance: "2026-07-13", statut: "À faire", dateCloture: null, remarque: null },
    { id: "ACT-004", dateEncodage: "2026-07-09", introduitPar: "Daniel Mülverstedt", origine: "Qualité ERP", contextLink: { module: "erpQuality", id: "ERP-003", label: "ERP-003", href: "/qualite-erp/ERP-003" }, description: "Corriger la machine de l’opération 20 — Compléter le routage ERP de l’OF-240203.", responsable: "Julie Qualité", echeance: "2026-07-16", statut: "Reporté", dateCloture: null, remarque: "Validation méthode nécessaire." },
    { id: "ACT-005", dateEncodage: "2026-07-11", introduitPar: "Daniel Mülverstedt", origine: "Réunion de production", contextLink: { module: "meeting", id: "MEET-PROD-07", label: "MEET-PROD-07", href: "/reunions/production" }, description: "Valider le contrôle première pièce — Contrôler le carter prototype avant poursuite de série.", responsable: "Julie Qualité", echeance: "2026-07-12", statut: "Fait", dateCloture: "2026-07-12T14:30:00.000Z", remarque: "PV ajouté au dossier atelier." },
  ],
  maintenance: [
