...
export const initialDemoData: DemoData = {
  ...
  actions: [
    { id: "ACT-001", dateEncodage: "2026-07-11", introduitPar: "Daniel Mülverstedt", origine: "QRQC", contextLinks: [{ module: "meeting", id: "MEET-QRQC-12", label: "MEET-QRQC-12", href: "/reunions/qrqc" }, { module: "machine", id: "FRA-10", label: "FRA-10", href: "/machines/FRA-10" }, { module: "maintenance", id: "FRA-10", label: "Maintenance FRA-10", href: "/machines/FRA-10" }], description: "Confirmer la fenêtre de maintenance FRA-10 — Valider avec la maintenance que l’OF-240184 peut démarrer mardi.", responsable: "Marc Lambert", responsableContactId: "CT-032", echeance: "2026-07-13", statut: "À faire", dateCloture: null, remarque: "Créneau proposé à 05 h 00.", comments: [{ id: "ACT-001-C1", author: "Daniel Mülverstedt", date: "2026-07-11T08:15:00.000Z", text: "Créneau proposé à 05 h 00, à confirmer avec l’équipe maintenance." }], history: [], priority: "Haute", responsableId: "person-marc-lambert", estimatedHours: 2, plannedWeek: "2026-W28", planningOrder: 0, parentActionId: null, besoinType: null },
    { id: "ACT-002", dateEncodage: "2026-07-10", introduitPar: "Daniel Mülverstedt", origine: "Planning", contextLinks: [{ module: "workOrder", id: "OF-240191", label: "OF-240191", href: "/of/OF-240191" }], description: "Relancer le fournisseur matière — Obtenir une date ferme pour le complément 316L.", responsable: "Sophie Martin", responsableContactId: null, echeance: "2026-07-14", statut: "À faire", dateCloture: null, remarque: null, comments: [], history: [], priority: "Normale", responsableId: null, estimatedHours: 3, plannedWeek: null, planningOrder: null, parentActionId: null, besoinType: null },
    { id: "ACT-003", dateEncodage: "2026-07-13", introduitPar: "Daniel Mülverstedt", origine: "Parc machines", contextLinks: [{ module: "machine", id: "FIL-01", label: "FIL-01", href: "/machines/FIL-01" }], description: "Replanifier la découpe fil — Identifier une alternative compatible pendant la panne FIL-01.", responsable: "Sophie Planification", responsableContactId: "CT-030", echeance: "2026-07-13", statut: "À faire", dateCloture: null, remarque: null, comments: [], history: [], priority: "Urgente", responsableId: "person-sophie-planification", estimatedHours: 4, plannedWeek: null, planningOrder: null, parentActionId: null, besoinType: null },
    { id: "ACT-004", dateEncodage: "2026-07-09", introduitPar: "Daniel Mülverstedt", origine: "Qualité ERP", contextLinks: [{ module: "erpQuality", id: "ERP-003", label: "ERP-003", href: "/qualite-erp/ERP-003" }], description: "Corriger la machine de l’opération 20 — Compléter le routage ERP de l’OF-240203.", responsable: "Julie Qualité", responsableContactId: "CT-031", echeance: "2026-07-16", statut: "Reporté", dateCloture: null, remarque: "Validation méthode nécessaire.", comments: [], history: [], priority: "Basse", responsableId: "person-julie-qualite", estimatedHours: 1.5, plannedWeek: "2026-W28", planningOrder: 0, parentActionId: null, besoinType: null },
    { id: "ACT-005", dateEncodage: "2026-07-11", introduitPar: "Daniel Mülverstedt", origine: "Réunion de production", contextLinks: [{ module: "meeting", id: "MEET-PROD-07", label: "MEET-PROD-07", href: "/reunions/production" }], description: "Valider le contrôle première pièce — Contrôler le carter prototype avant poursuite de série.", responsable: "Julie Qualité", responsableContactId: "CT-031", echeance: "2026-07-12", statut: "Fait", dateCloture: "2026-07-12T14:30:00.000Z", remarque: "PV ajouté au dossier atelier.", comments: [], history: [], priority: "Normale", responsableId: "person-julie-qualite", estimatedHours: 2, plannedWeek: "2026-W27", planningOrder: 0, parentActionId: null, besoinType: null },
  ],
  maintenance: [
  ...
  maintenanceProblems: [],
  meetings: [
    { id: "MEET-QRQC-12", type: "QRQC", date: "2026-07-13T07:30:00.000Z", status: "Préparation", createdByUserId: null, sharedAt: "2026-07-12T16:00:00.000Z", preparationSentAt: null, preparationSentVia: null, startedAt: null, closedAt: null, archivedAt: null, responsableContactId: "CT-012", participants: [{ contactId: "CT-012", present: true }, { contactId: "CT-030", present: true }, { contactId: "CT-031", present: true }], notes: [], decisions: [], parkingLot: [], actionIds: ["ACT-001"], priorityDossiers: [], maintenanceProblemIds: [], fieldPoints: [], fieldRoundCompletedContactIds: [], fieldRoundNoIssueContactIds: [], recapDocument: null, criticalWorkOrderIds: [] },
    { id: "MEET-PROD-07", type: "Production", date: "2026-07-14T09:30:00.000Z", status: "En cours", createdByUserId: null, sharedAt: "2026-07-13T10:00:00.000Z", preparationSentAt: "2026-07-13T10:05:00.000Z", preparationSentVia: "email", startedAt: "2026-07-14T09:30:00.000Z", closedAt: null, archivedAt: null, responsableContactId: "CT-012", participants: [{ contactId: "CT-012", present: true }, { contactId: "CT-030", present: true }, { contactId: "CT-032", present: true }], notes: [{ step: "Dossiers prioritaires", text: "Préparer l’arbitrage découpe fil." }], decisions: [], parkingLot: [], actionIds: ["ACT-005"], priorityDossiers: ["OF-240184", "OF-240191", "OF-240203", "OF-240211", "OF-240167"].map((referenceId, index) => ({ id: `MEET-PROD-07-DOS-${index + 1}`, title: referenceId, description: "", preparationComment: "", meetingComment: "", decision: "", status: "À discuter" as const, referenceKind: "workOrder" as const, referenceId, actionIds: [] })), maintenanceProblemIds: [], fieldPoints: [], fieldRoundCompletedContactIds: [], fieldRoundNoIssueContactIds: [], recapDocument: null, criticalWorkOrderIds: ["OF-240184", "OF-240191", "OF-240203", "OF-240211", "OF-240167"] },
  ],
  requests: [
  ...
  contacts: [
    ...
    { id: "CT-030", type: "Interne", firstName: "Sophie", lastName: "Planification", company: null, role: "Responsable planification", categoryIds: ["contact-category-production"], phone: null, mobile: null, internalNumber: null, privateNumber: null, email: "sophie.planification@tkmi.be", address: null, website: null, notes: null },
    { id: "CT-031", type: "Interne", firstName: "Julie", lastName: "Qualité", company: null, role: "Responsable qualité", categoryIds: ["contact-category-qualite"], phone: null, mobile: null, internalNumber: null, privateNumber: null, email: "julie.qualite@tkmi.be", address: null, website: null, notes: null },
    { id: "CT-032", type: "Interne", firstName: "Marc", lastName: "Lambert", company: null, role: "Responsable maintenance", categoryIds: ["contact-category-maintenance"], phone: null, mobile: null, internalNumber: null, privateNumber: null, email: "marc.lambert@tkmi.be", address: null, website: null, notes: null },
