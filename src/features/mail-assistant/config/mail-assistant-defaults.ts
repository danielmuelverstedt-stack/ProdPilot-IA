...
export const MAIL_ASSISTANT_START_DEFAULTS: MailAssistantStartSettings = { speakOpeningBrief: true, askFollowUpQuestion: true, autoListenAfterBrief: true, includePendingDrafts: true, includeMessagesWithoutStatus: true, includeOverdueFollowUps: true, includeInformationalMessages: true, maximumItemsSpoken: 7, briefDetail: "compact", replayButtonVisible: true, voiceEnabled: true, speechRate: 0.9, speechVolume: 1, preferredLanguage: "fr-FR", preferredVoiceName: "", listeningBehavior: "manual", workflowStatuses: MAIL_WORKFLOW_STATUSES, voiceInteractionEnabled: true, inputMode: "click_to_talk", pushToTalkShortcut: "f8", customShortcut: "", recognitionLanguage: "fr-FR", continuousConversation: true, silenceTimeoutSeconds: 8, pauseAfterSpeechMs: 350, disableContinuousOnBlur: true, transcriptPreview: true, submitAutomatically: true, voiceOutputEnabled: true, writtenResponseEnabled: true, assistantVoicePreset: "system", speechPitch: 1, speakConfirmations: true, speakExecutionSummaries: true, longAnswerSpeech: "summary", interruptAssistantBySpeaking: false, ttsProvider: "system-browser", selectedMicrophoneDeviceId: "", microphoneTestDurationSeconds: 6, preferredVoiceId: "", preferredVoiceLocale: "fr-FR", voiceFallbackStrategy: "uri_name_locale_default" };
