...
function StepTabs({ steps, activeStep, disabled, onSelect }: { steps: string[]; activeStep: number; disabled: boolean; onSelect: (step: number) => void }) {
