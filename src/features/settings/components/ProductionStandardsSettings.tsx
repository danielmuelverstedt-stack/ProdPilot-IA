...
type StandardKey = "departments" | "priorities" | "statuses" | "maintenanceStatuses" | "taskTypes" | "maintenanceTypes";
...
function StandardsEditor<T extends OrderedStandardSettings>({ title, description, settingKey, items, extra, createExtra = {} }: {
  title: string;
  description: string;
